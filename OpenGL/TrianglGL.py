...
def draw_cube():
    ...
    glBegin(GL_TRIANGLES)  # Iniciar el cubo como un conjunto de caras (quads)

    # Cada conjunto de tres vértices representa una cara de la pirámide
    ...
    angle += 0.05  # Incrementar el ángulo para rotación
